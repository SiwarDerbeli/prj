...
boolean result =(this.resetPasswordRepository.verifyCode(newPasswordRequest.getEmail(),newPasswordRequest.getRecoveryCode(),System.currentTimeMillis()))>=1;
    ...
    private void postConstruct() {
        ...
        authenticationRepository.save(new UserMapper("siwarderbeli245@gmail.com","student"+"Siwar","student"+"Derbeli",Role.STUDENT));
      ...
      for(int i =1 ;i<=20;i++){
          if(!authenticationRepository.existsById("student"+String.valueOf(i)+"@gmail.com"))
              authenticationStudentRepository.save(new StudentMapper("student"+String.valueOf(i)+"@gmail.com","student"+String.valueOf(i)+"Firstname","student"+String.valueOf(i)+"Lastname",Role.STUDENT,i+10000));
      }
        for(int i =6 ;i<=20;i++){
